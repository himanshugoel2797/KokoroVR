...
{
    public class ChunkObject   //Represents a composite chunk object, eventually we want to be able to break off disconnected chunks
    {
        ...
        public void Render(double time)
        {
            ...
            var chunks = ChunkTree.GetVisibleChunks(Engine.Frustum);
